...
export default function CataloguePage() {
    ...
    return (
        <main className="min-h-screen bg-black flex flex-col pt-32 font-sans">
            ...
            {/* Grid Section */}
            <div className="w-full bg-black py-16 px-6 md:px-12 flex justify-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 md:gap-x-16 gap-y-12 md:gap-y-16 max-w-[1100px] w-full">
                    {artworks.map((art) => (
                        <div
                            key={art.id}
