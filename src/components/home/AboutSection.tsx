...
const AboutSection = () => {
    return (
        <section className="relative w-full min-h-[60vh] lg:min-h-[80vh] bg-black text-white py-12 md:py-16 overflow-hidden flex flex-col items-center justify-center text-center">
